...
module.exports = {
    ...
    createPage: function(currentConfig){
        console.log('The type of currentConfig is ' + typeof currentConfig);
        console.log('The type of currentConfig.lightType is ' + typeof currentConfig.lightType);
        let bulbType = currentConfig.lightType.value;
